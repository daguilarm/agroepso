<?php
// dusk tests/Browser/Feature/Biocides/CreateTest.php
...
class CreateTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->routeIndex = route('dashboard.tools.biocides.index');
        $this->routeCreate = route('dashboard.tools.biocides.create');
