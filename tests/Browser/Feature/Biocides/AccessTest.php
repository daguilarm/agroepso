<?php
// dusk tests/Browser/Feature/Biocides/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = 'dashboard.tools.biocides.index';
    }

    /**
     * Verify the biocides access to the route
     *
     * @return void
     */
    function test_biocides_access()
    {
