<?php
// dusk tests/Browser/Feature/Modules/CreateTest.php
...
class CreateTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->routeIndex = route('dashboard.tools.modules.index');
        $this->routeCreate = route('dashboard.tools.modules.create');
