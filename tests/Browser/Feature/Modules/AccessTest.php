<?php
// dusk tests/Browser/Feature/Modules/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = 'dashboard.tools.modules.index';
    }

    /**
     * Verify the modules access to the route
     *
     * @return void
     */
    function test_modules_access()
    {
