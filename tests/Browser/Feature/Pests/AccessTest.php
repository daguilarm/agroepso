<?php
// dusk tests/Browser/Feature/Pests/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = route('dashboard.tools.pests.show', 1);
    }

    /**
     * Verify the pests access to the route
     *
     * @return void
     */
    function test_pests_access()
    {
