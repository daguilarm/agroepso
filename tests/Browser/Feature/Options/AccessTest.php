<?php
// dusk tests/Browser/Feature/Options/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = 'dashboard.tools.options.index';
    }

    /**
     * Verify the options access to the route
     *
     * @return void
     */
    function test_options_access()
    {
