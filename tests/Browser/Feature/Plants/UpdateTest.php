<?php
// dusk tests/Browser/Feature/Plants/UpdateTest.php
...
class UpdateTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
         ...
         * @var custom
         */
        $this->last = Plant::orderBy('id', 'desc')->first();
        $this->faker = app(Faker::class);
        $this->route = route('dashboard.plants.edit', $this->last->id);
