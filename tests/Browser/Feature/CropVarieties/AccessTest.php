<?php
// dusk tests/Browser/Feature/CropVarieties/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = route('dashboard.tools.crop_varieties.show', 1);
    }

    /**
     * Verify the crop_varieties access to the route
     *
     * @return void
     */
    function test_crop_varieties_access()
    {
