<?php
// dusk tests/Browser/Feature/Cities/AccessTest.php
...
class AccessTest extends CustomDuskTestCase
{
    ...
    public function setUp()
    {
        ...
        //Vars
        $this->route = 'dashboard.tools.cities.index';
    }

    /**
     * Verify the cities access to the route
     *
     * @return void
     */
    function test_cities_access()
    {
